...
const Toast = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  crossfade({
    ...
    fallback(node) {
      ...
      return {
        ...
        easing: cubicInOut,
        css: (t, u) => `
					transform: ${transform} scale(${t}) translate(${u * animAxis.x}%, ${
            u * animAxis.y
          }%);
					opacity: ${t}
				`,
  ...
  if (
    $$props.buttonAction === void 0 &&
    $$bindings.buttonAction &&
    buttonAction !== void 0
  )
    $$bindings.buttonAction(buttonAction);
  if (
    $$props.buttonDismiss === void 0 &&
    $$bindings.buttonDismiss &&
    buttonDismiss !== void 0
  )
    $$bindings.buttonDismiss(buttonDismiss);
  if (
    $$props.buttonDismissLabel === void 0 &&
    $$bindings.buttonDismissLabel &&
    buttonDismissLabel !== void 0
  )
  ...
  return `${
    $toastStore.length
      ? `
	<div class="${
    'snackbar-wrapper ' + escape(classesWrapper, true)
  }" data-testid="snackbar-wrapper">
		<div class="${'snackbar ' + escape(classesSnackbar, true)}">${each(
      filteredToasts,
      (t, i) => {
        return `<div>
					<div class="${
            'toast ' +
            escape(classesToast, true) +
            ' ' +
            escape(t.background ?? background, true) +
            ' ' +
            escape(t.classes ?? '', true)
          }" role="alert" aria-live="polite" data-testid="toast"><div class="text-base"><!-- HTML_TAG_START -->${
            t.message
          }<!-- HTML_TAG_END --></div>
						${
              t.action || !t.hideDismiss
                ? `<div class="${
                    'toast-actions ' + escape(cToastActions, true)
                  }">${
                    t.action
                  ...
                  !t.hideDismiss
                    ? `<button${add_attribute(
                        ...
                        buttonDismiss,
                        0,
                      )}>${escape(buttonDismissLabel)}</button>`
                    : ``
                }
							</div>`
                : ``
