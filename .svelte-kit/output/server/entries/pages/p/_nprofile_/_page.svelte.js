...
import {
  n as nowProgress,
  b as bookmarkEvents,
  R as RelaysforSearch,
  M as Modal,
  P as ProgressRadial,
} from '../../../../chunks/ModalImage.svelte_svelte_type_style_lang.js';
...
const AppBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if (
    $$props.gridColumns === void 0 &&
    $$bindings.gridColumns &&
    gridColumns !== void 0
  )
  ...
  if ($$props.gap === void 0 && $$bindings.gap && gap !== void 0)
    $$bindings.gap(gap);
  if (
    $$props.regionRowMain === void 0 &&
    $$bindings.regionRowMain &&
    regionRowMain !== void 0
  )
  ...
  if (
    $$props.slotDefault === void 0 &&
    $$bindings.slotDefault &&
    slotDefault !== void 0
  )
    $$bindings.slotDefault(slotDefault);
  if (
    $$props.slotTrail === void 0 &&
    $$bindings.slotTrail &&
    slotTrail !== void 0
  )
  ...
  classesBase = `${cBase$2} ${background} ${border} ${spacing} ${padding} ${shadow} ${
    $$props.class ?? ''
  }`;
  ...
  return `<div class="${
  ...
  }" data-testid="app-bar" role="toolbar"${add_attribute(
    'aria-label',
    label,
    0,
  )}${add_attribute('aria-labelledby', labelledby, 0)}>
	<div class="${'app-bar-row-main ' + escape(classesRowMain, true)}">
		${
      $$slots.lead
        ? `<div class="${
            'app-bar-slot-lead ' + escape(classesSlotLead, true)
          }">${slots.lead ? slots.lead({}) : ``}</div>`
        : ``
    }
      ...
      $$slots.trail
        ? `<div class="${
            'app-bar-slot-trail ' + escape(classesSlotTrail, true)
          }">${slots.trail ? slots.trail({}) : ``}</div>`
        : ``
    }</div>
    ...
    $$slots.headline
      ? `<div class="${
          'app-bar-row-headline ' + escape(classesRowHeadline, true)
        }">${slots.headline ? slots.headline({}) : ``}</div>`
      : ``
  }</div>`;
});
...
const QueryClientProvider = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
function useConnections({ rxNostr, relays }) {
  ...
  const init = relays.map((relay) => {
    ...
    const state = rxNostr.hasRelay(from2)
      ? rxNostr.getRelayState(from2)
      : 'not-started';
    return { from: from2, state };
  });
  return rxNostr.createConnectionStateObservable().pipe(
    startWith(...init),
    scanLatestEach(({ from: from2 }) => from2),
  );
}
const NostrApp = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let connections;
    let mergedQueryClientConfig;
    let queryClient;
    let $connections,
      $$unsubscribe_connections = noop,
      $$subscribe_connections = () => (
        $$unsubscribe_connections(),
        ($$unsubscribe_connections = subscribe(
          connections,
    ...
    if (
      $$props.queryClientConfig === void 0 &&
      $$bindings.queryClientConfig &&
      queryClientConfig !== void 0
    )
    ...
    return `${validate_component(
      ...
      {},
      {
        default: () => {
          return `${
            slots.default ? slots.default({ connections: $connections }) : ``
          }`;
        },
      },
    )}`;
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_nowProgress = subscribe(
    nowProgress,
    (value) => ($nowProgress = value),
  );
  $$unsubscribe_bookmarkEvents = subscribe(
    bookmarkEvents,
    (value) => ($bookmarkEvents = value),
  );
  ...
  do {
    $$settled = true;
    $$rendered = `${
      (($$result.head += `<!-- HEAD_svelte-wjxbk9_START --><meta prefix="og: https://ogp.me/ns#"><meta property="og:title" content="nostr-bookmark-viewer3"><meta property="og:description" content="${
        'nprofile:pubkey:' + escape(pubkey, true)
      }"><meta property="og:image" content="https://nostr-bookmark-viewer3.vercel.app/img2.png"><!-- HEAD_svelte-wjxbk9_END -->`),
      '')
    }
...
<main class="container max-w-5xl px-1 mt-24 mb-12">${
      !$bookmarkEvents || $bookmarkEvents.length === 0
        ? `${escape(message)}`
        : `<div class="w-full fixed top-0 left-1/2 transform -translate-x-1/2 z-10"><div class="max-w-screen-lg m-auto z-10">${validate_component(
            AppBar,
            'AppBar',
          ).$$render(
            $$result,
          ...
          `;
              ...
              default: () => {
                return `<div class="tabGroup svelte-cq9msn">${validate_component(
                  TabGroup,
                  'TabGroup',
                ).$$render(
                  $$result,
                  {
                    ...
                    rounded:
                      'rounded-tl-container-token rounded-tr-container-token',
                  },
                  {},
                  {
                    default: () => {
    ...
    ${validate_component(NostrApp, 'NostrApp').$$render(
      $$result,
...
<div class="container max-w-5xl mx-auto z-10">${
      ...
      <button type="button" class="btn-icon variant-filled-surface mx-1">↻</button></div>`
        : `<div class="fixed bottom-2 right-2">${validate_component(
            ProgressRadial,
            'ProgressRadial',
          ).$$render(
            $$result,
