import { o as De, t as ye } from '../chunks/index.e81ade4b.js';
import {
  S as He,
  a as Je,
  I as V,
  ...
  P as qe,
  h as We,
} from '../chunks/singletons.2b260291.js';
function Xe(t, o) {
  return t === '/' || o === 'ignore'
    ? t
    : o === 'never'
...
window.fetch = (t, o) => (
  (t instanceof Request
    ? t.method
    : (o == null ? void 0 : o.method) || 'GET') !== 'GET' && ne.delete(Se(t)),
  fe(t, o)
);
const ne = new Map();
function it(t, o) {
  ...
  if (i != null && i.textContent) {
    ...
    return (
      S && ne.set(u, { body: d, init: f, ttl: 1e3 * Number(S) }),
  ...
  for (const u in t)
    if (typeof ((o = t[u]) == null ? void 0 : o.then) == 'function')
      return Object.fromEntries(
        await Promise.all(
          Object.entries(t).map(async ([i, d]) => [i, await d]),
        ),
      );
  return t;
}
...
function Rt(t, o) {
  ...
  const f = document.documentElement,
    ...
    l = [];
  let w = null;
  const _ = { before_navigate: [], after_navigate: [] };
  ...
  async function Le(e) {
    return (
      (w = {
        id: e.id,
        promise: he(e).then(
          (n) => (n.type === 'loaded' && n.state.error && (w = null), n),
        ),
      }),
      w.promise
    );
  ...
  async function de({
    ...
    if ((y = v.universal) != null && y.load) {
      ...
      (g = (await v.universal.load.call(null, b)) ?? null),
        (g = g ? await ht(g) : null);
    }
    return {
      node: v,
    ...
    if (b.some(Boolean)) {
      try {
        ...
        return ie({
          ...
          error: await Z(E, { url: r, params: a, route: { id: s.id } }),
          url: r,
          route: s,
        });
      }
      ...
      if (v[E])
        try {
          ...
          if (h != null && h.includes(L)) (I = L.status ?? I), (T = L.error);
            ...
            T = await Z(L, { params: a, url: r, route: { id: s.id } });
          }
  ...
  async function ce({
    ...
    if (b.type === 'redirect')
      if (a.length > 10 || a.includes(e.pathname))
        ...
        return re(new URL(b.location, e).href, {}, [...a, e.pathname], m), !1;
    else
      (($ = b.props.page) == null ? void 0 : $.status) >= 400 &&
    ...
    if (
      ...
      (C = b.props.page) != null &&
        C.url &&
        b.props.page.url.pathname !== e.pathname &&
        (e.pathname = (E = b.props.page) == null ? void 0 : E.url.pathname),
      s)
    ) {
    ...
    (w = null),
      x
        ? ((p = b.state),
          b.props.page && (b.props.page.url = e),
          q.$set(b.props))
        : Oe(b);
    ...
    !r && !U && Ee(),
      (k = !0),
      b.props.page && (F = b.props.page),
      (P = !1),
      c === 'popstate' && Ae(j),
      _.after_navigate.forEach((L) => L(A)),
  ...
  return {
    ...
    _hydrate: async ({
      ...
      ({ params: a = {}, route: s = { id: null } } = X(m, !1) || {});
      let v;
      try {
        ...
        v = await ie({
          ...
          error: await Z(y, { url: m, params: a, route: s }),
          url: m,
          route: s,
        });
      }
          ...
          (p = N.nodes) == null ||
            p.forEach((P) => {
              (P == null ? void 0 : P.type) === 'data' &&
                ((P.uses = Ge(P.uses)), (P.data = w(P.data)));
            }),
            d(N);
