...
function p(t, r, e) {
  return e
    ? r
      ? r(t)
      : t
    : ((t && t.then) || (t = Promise.resolve(t)), r ? t.then(r) : t);
}
function L() {}
var j = { type: 'SKIP_WAITING' };
function P(t, r) {
  if (!r) return t && t.then ? t.then(L) : Promise.resolve();
}
var x = (function (t) {
  var r, e;
  function i(v, c) {
              ...
              p(o.bn(), function (s) {
                (o.fn = s),
                  o.yn &&
                    ...
                    o.en.resolve(o.yn),
                    o.on.resolve(o.yn),
                    o.yn.addEventListener('statechange', o.ln, { once: !0 }));
                var a = o.fn.waiting;
                return (
                  a &&
  ...
  (function () {
    ...
    var r = t.prototype;
    return (
      (r.addEventListener = function (e, i) {
        this.Sn(e).add(i);
      }),
